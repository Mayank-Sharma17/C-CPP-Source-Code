...
class Complex {
    ...
    public:
        ...
        Complex (Complex &C) { // COPY CONSTRUCTOR, c1 data is copied to C, ERROR - copy constructor for class Complex may not have a parameter of type Complex !
                              // solution - don't create an object instead, make it reference &C
            a=C.a;
            b=C.b;
        }
        void showData(); 
